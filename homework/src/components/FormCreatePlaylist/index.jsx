...
const FormCreatePlaylist = ({accessToken, userId, uris}) => {
...
const handleSubmit = async (e) => {
    ...
    const responseCreatePlaylist = await fetch(`${config.SPOTIFY_BASE_URL}/users/${userId}/playlists`, optionsFormCreatePlaylist).then(data=> data.json());
