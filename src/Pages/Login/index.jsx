...
const Login = () => {
  ...
  const getLinkAuth = () => {
    ...
    return `https://accounts.spotify.com/authorize?client_id=${clientId}&response_type=token&redirect_uri=http://spotify-project-zefanyanya.vercel.app&state=${state}&scope=${config.SPOTIFY_SCOPE}`;
  };
